...
def main(args):
    ...
    # if args.lr_decay:
        # optimizer = optim.Adagrad(model.parameters(), lr_decay=0.1, lr=args.learning_rate, weight_decay=args.weight_decay)
        ...
        for epoch in range(start_epoch, epochs):
            ...
            for batch, labels in self.train_loader:
                ...
                if ((self.step + 1) % print_frequency) == 0:
                    self.print_metrics(epoch, loss, data_load_time, step_time, args.learning_rate)
